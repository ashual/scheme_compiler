...
// My definitions
#define ENV (FPARG(0))
#define ARGS_NUM (FPARG(1))
#define MY_ARGS(n) (FPARG(2+(n)))
...
#define PRINT_MEM  {printf("Mem: "); int i; for(i=1; i < IND(0); ++i) { printf("(%d = %lu)  ", i, IND(i)); } printf("\n");}
#define PRINT_STACK  {printf("Stack: "); int i; for(i=SP-1; i >= 0; --i) { printf("(%d = %lu)  \n", i, STACK(i)); } }
